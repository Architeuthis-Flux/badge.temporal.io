...
constexpr const char* kNvsLastLayout = "last_layout";

constexpr size_t kTagMax = 32;
constexpr size_t kUrlMax = 1536;

// 16 MB layout marker. `_doom` has ffat at 0x7D0000; `_ver2` has ffat
// at 0x910000. OTA is layout-agnostic, but the UI can explain changes.
