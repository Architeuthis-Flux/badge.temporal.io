...
| Submit or share a Community App | Add an app folder under [`registry/community_apps/`](registry/community_apps/), then follow [`registry/README.md`](registry/README.md) |
